...
class OperationCustomer(models.Model):
    ...
    def clean(self):
        # Her operasyonda en az bir satın alan kişi olmalı
        if not self.is_buyer and not self.operation.customers.filter(is_buyer=True).exists():
            raise ValidationError("At least one customer must be marked as buyer")
...
class OperationDay(models.Model):
    ...
    def __str__(self):
        return f"{self.operation.reference_number} - {self.date}"
...
class OperationItem(models.Model):
    ...
    vehicle_cost_price = models.DecimalField(verbose_name="Vehicle Cost Price", max_digits=10, decimal_places=2, blank=True, null=True)
    vehicle_cost_currency = models.ForeignKey(Currency, verbose_name="Vehicle Cost Currency", related_name='vehicle_cost_currency', on_delete=models.PROTECT, null=True, blank=True)
    ...
    no_vehicle_tour_cost_price = models.DecimalField(verbose_name="No Vehicle Tour Cost Price", max_digits=10, decimal_places=2, blank=True, null=True)
    no_vehicle_tour_cost_currency = models.ForeignKey(Currency, verbose_name="No Vehicle Tour Cost Currency", related_name='no_vehicle_tour_cost_currency', on_delete=models.PROTECT, null=True, blank=True)
    ...
    activity_cost_price = models.DecimalField(verbose_name="Activity Cost Price", max_digits=10, decimal_places=2, blank=True, null=True)
    activity_cost_currency = models.ForeignKey(Currency, verbose_name="Activity Cost Currency", related_name='activity_cost_currency', on_delete=models.PROTECT, null=True, blank=True)
...
class OperationSubItem(models.Model):
    ...
    tour_cost_price = models.DecimalField(verbose_name="Tour Cost Price", max_digits=10, decimal_places=2, blank=True, null=True)
    tour_cost_currency = models.ForeignKey(Currency, verbose_name="Tour Cost Currency", related_name='tour_cost_currency', on_delete=models.PROTECT, null=True, blank=True)

    transfer = models.ForeignKey(Transfer, verbose_name="Transfer", on_delete=models.PROTECT, null=True, blank=True)
    transfer_cost_price = models.DecimalField(verbose_name="Transfer Cost Price", max_digits=10, decimal_places=2, blank=True, null=True)
    transfer_cost_currency = models.ForeignKey(Currency, verbose_name="Transfer Cost Currency", related_name='transfer_cost_currency', on_delete=models.PROTECT, null=True, blank=True)

    museums = models.ManyToManyField(Museum, verbose_name="Museums", blank=True, null=True, related_name='museums')
    museum_cost_price = models.DecimalField(verbose_name="Museum Cost Price", max_digits=10, decimal_places=2, blank=True, null=True)
    museum_cost_currency = models.ForeignKey(Currency, verbose_name="Museum Cost Currency", related_name='museum_cost_currency', on_delete=models.PROTECT, null=True, blank=True)
    ...
    hotel_cost_price = models.DecimalField(verbose_name="Hotel Cost Price", max_digits=10, decimal_places=2, blank=True, null=True)
    hotel_cost_currency = models.ForeignKey(Currency, verbose_name="Hotel Cost Currency", related_name='hotel_cost_currency', on_delete=models.PROTECT, null=True, blank=True)
    ...
    guide_cost_price = models.DecimalField(verbose_name="Guide Cost Price", max_digits=10, decimal_places=2, blank=True, null=True)
    guide_cost_currency = models.ForeignKey(Currency, verbose_name="Guide Cost Currency", related_name='guide_cost_currency', on_delete=models.PROTECT, null=True, blank=True)
    ...
    other_price = models.DecimalField(verbose_name="Other Price", max_digits=10, decimal_places=2, null=True, blank=True)
    other_price_currency = models.ForeignKey(Currency, verbose_name="Other Price Currency", on_delete=models.PROTECT, null=True, blank=True)
