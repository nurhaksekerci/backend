# Generated by Django 5.0.1 on 2025-01-09 11:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cities', models.ManyToManyField(to='files.city', verbose_name='Cities')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('is_active', models.BooleanField(default=True, verbose_name='Is Active')),
                ('activity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='files.activity', verbose_name='Activity')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentication.company', verbose_name='Company')),
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='activity_costs', to='authentication.currency', verbose_name='Currency')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_cost', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='price_history', to='files.activitycost')),
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='authentication.currency')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='Is Active')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentication.company', verbose_name='Company')),
                ('cities', models.ManyToManyField(to='files.city', verbose_name='Service Cities')),
            ],
        ),
        migrations.AddField(
            model_name='activitycost',
            name='supplier',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='files.activitysupplier', verbose_name='Supplier'),
        ),
        migrations.CreateModel(
            name='BuyerCompany',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('is_active', models.BooleanField(default=True, verbose_name='Is Active')),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='files.city', verbose_name='City')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentication.company', verbose_name='Company')),
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='hotels', to='authentication.currency', verbose_name='Currency')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='authentication.currency')),
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='price_history', to='files.hotel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='files.city', verbose_name='City')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentication.company', verbose_name='Company')),
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='museums', to='authentication.currency', verbose_name='Currency')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='authentication.currency')),
                ('museum', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='price_history', to='files.museum')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='Is Active')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentication.company', verbose_name='Company')),
                ('end_city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tour_ends', to='files.city', verbose_name='End City')),
                ('start_city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tour_starts', to='files.city', verbose_name='Start City')),
            ],
        ),
        migrations.CreateModel(
            name='Transfer',
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='Is Active')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentication.company', verbose_name='Company')),
                ('end_city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfer_ends', to='files.city', verbose_name='End City')),
                ('start_city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfer_starts', to='files.city', verbose_name='Start City')),
            ],
        ),
        migrations.CreateModel(
            name='VehicleCost',
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='Is Active')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentication.company', verbose_name='Company')),
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='vehicle_costs', to='authentication.currency', verbose_name='Currency')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='authentication.currency')),
                ('vehicle_cost', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='price_history', to='files.vehiclecost')),
            ],
            options={
